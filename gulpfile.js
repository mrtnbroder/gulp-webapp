...
gulp.task('css', function() {
  return gulp.src(['.tmp/styles/{,*/}*.css', 'app/styles/{,*/}*.css']).pipe(concat('styles.css')).pipe(rename('styles.min.css')).pipe(autoprefixer('last 2 version')).pipe(csso()).pipe(gulp.dest('dist/styles'));
});
